  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
      <div className="p-4 border-b border-slate-200 dark:border-slate-700 flex flex-wrap items-center gap-4">
        ...
        <PermissionGate menuId={MENU_ID.DEPARTMENTS} action="create">
          <AppLink
              ...
              >
                ...
                <td className="p-4">
                  <div className="flex gap-2">
                    <PermissionGate menuId={MENU_ID.DEPARTMENTS} action="update">
                      <AppLink
                    ...
                    <PermissionGate menuId={MENU_ID.DEPARTMENTS} action="delete">
                      <button
